      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-hero font-bold text-mint-900 mb-6">Acceptable Use Policy</h1>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
            <div className="prose prose-lg max-w-none">
              <p className="text-body text-mint-700 mb-8">
                This acceptable use policy covers the products, services, and technologies (collectively referred to as the "Products") provided by CSOgo under any ongoing agreement. It's designed to protect us, our customers and the general Internet community from unethical, irresponsible and illegal activity.
              </p>

              <p className="text-body text-mint-700 mb-8">
                CSOgo customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities.
              </p>

              <p className="text-body text-mint-700 mb-8">
                <strong>This policy was last reviewed on 28 October 2025.</strong>
              </p>

              <section className="space-y-6">
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Fair use</h2>
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Customer accountability</h2>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Prohibited activity</h2>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Copyright infringement and access to unauthorised material</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">SPAM and unauthorised message activity</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Unethical, exploitative, and malicious activity</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Unauthorised use of CSOgo property</h3>
                  <p className="text-body text-mint-700 mb-4">
                    We prohibit the impersonation of CSOgo, the representation of a significant business relationship with CSOgo, or ownership of any CSOgo property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage or user trust.
                  </p>
                </div>

                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">About this policy</h2>
                  <p className="text-body text-mint-700 mb-4">
