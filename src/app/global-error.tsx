                ...
                <ScaleIn>
                  <div className="card card-lg max-w-2xl mx-auto">
                    ...
                    >
                      ...
                      <h1 className="text-heading mb-4">Critical Error</h1>
                    ...
                    <SlideIn delay={0.2}>
                      <div className="mb-8">
                        <p className="text-body-lg text-gray-700 mb-6">
                          A critical error occurred. Please try again or choose one of the options below.
                        </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        ...
                        <Hover>
                          ...
                          >
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Self Assessment Login</h3>
                            <p className="text-sm text-gray-600">Access your self assessment dashboard</p>
                          </Link>
                        </Hover>
