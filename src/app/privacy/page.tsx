          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
            <div className="prose prose-lg max-w-none">
              <p className="text-body text-mint-700 mb-8">
                Your privacy is important to us. It is CSOgo's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://csogo.org/, and other sites we own and operate.
              </p>
              ...
              <p className="text-body text-mint-700 mb-8">
                <strong>This policy is effective as of 13 October 2025</strong>
              </p>

              <p className="text-body text-mint-700 mb-8">
                <strong>Last updated: 28 October 2025</strong>
              </p>
              ...
              <section className="space-y-6">
                <div>
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Log data</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Device data</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Personal information</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">User-generated content</h3>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Legitimate reasons for processing your personal information</h2>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Collection and use of information</h2>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Security of your personal information</h2>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">How long we keep your personal information</h2>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Children's privacy</h2>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Disclosure of personal information to third parties</h2>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <p className="text-body text-mint-700 mb-4">
                    <strong>Third parties we currently use include:</strong>
                  </p>
                  <ul className="list-disc ml-6 space-y-2 text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">International transfers of personal information</h2>
                  <p className="text-body text-mint-700 mb-4">
                    The personal information we collect is stored and/or processed in Trinidad and Tobago, United States of America (the), or where we or our partners, affiliates, and third-party providers maintain facilities.
                  </p>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Your rights and controlling your personal information</h2>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <p className="text-body text-mint-700 mb-4">
                    <strong>Downloading of personal information:</strong> We provide a means for you to download the personal information you have shared through our site. Please contact us for more information.
                  </p>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Business transfers</h2>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Limits of our policy</h2>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Changes to this policy</h2>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Additional disclosures for U.S. states privacy law compliance</h2>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Do not track</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">California privacy laws - CPPA</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">California notice of collection</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Right to know and delete</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Shine the light</h3>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Additional disclosures for General Data Protection Regulation (GDPR) compliance (EU)</h2>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Data controller / data processor</h3>
                  <p className="text-body text-mint-700 mb-4">
                    The GDPR distinguishes between organisations that process personal information for their own purposes (known as "data controllers") and organisations that process personal information on behalf of other organisations (known as "data processors"). We, CSOgo, located at the address provided in our Contact Us section, are a Data Controller with respect to the personal information you provide to us.
                  </p>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Legal bases for processing your personal information</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <p className="text-body text-mint-700 mb-4">
                    <strong>Compliance with the law</strong><br />
                    In some cases, we may have a legal obligation to use or keep your personal information. Such cases may include (but are not limited to) court orders, criminal investigations, government requests, and regulatory obligations. If you have any further enquiries about how we retain personal information in order to comply with the law, please feel free to enquire using the details provided in the Contact Us section of this privacy policy.
                  </p>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">International Transfers Outside of the European Economic Area (EEA)</h3>
                  <p className="text-body text-mint-700 mb-4">
                    We will ensure that any transfer of personal information from countries in the European Economic Area (EEA) to countries outside the EEA will be protected by appropriate safeguards, for example by using standard data protection clauses approved by the European Commission, or the use of binding corporate rules or other legally accepted means.
                  </p>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Your rights and controlling your personal information</h3>
                  <p className="text-body text-mint-700 mb-4">
                    <strong>Restrict:</strong> You have the right to request that we restrict the processing of your personal information if: you are concerned about the accuracy of your personal information; you believe your personal information has been unlawfully processed; you need us to maintain the personal information solely for the purpose of a legal claim; or we are in the process of considering your objection in relation to processing on the basis of legitimate interests.
                  </p>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Additional disclosures for Australian Privacy Act compliance (AU)</h2>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">International transfers of personal information</h3>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Additional disclosures for Personal Information Protection and Electronic Documents Act (PIPEDA) compliance (Canada)</h2>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Additional scope of personal information</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <p className="text-body text-mint-700 mb-4">
                    As PIPEDA refers to personal information using the term Personally Identifying Information (PII), any references to personal information and PII in this privacy policy, and in official communications from CSOgo, are intended as equivalent to one another in every way, shape and form.
                  </p>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Valid consent</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">International transfers of information</h3>
                  <p className="text-body text-mint-700 mb-4">
                    While CSOgo endeavours to keep, store and handle customer data within locations in Canada, it may use agents or service providers located in the United States (U.S.), European Economic Area (EEA) or United Kingdom (UK) to collect, use, retain and process personal information as part of providing services to you. While we use all reasonable efforts to ensure that personal information receives the same level of security in any other jurisdiction as it would in Canada, please be aware that privacy protections under U.S. laws may not be the same adequacy.
                  </p>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Customer data rights</h3>
                  <p className="text-body text-mint-700 mb-4">
                    Although PIPEDA does not contain an extensive set of consumer rights, it does grant consumers the right to:
                  </p>
                  <ul className="list-disc ml-6 space-y-2 text-body text-mint-700 mb-4">
                    <li>Access the personal information organisations hold about them;</li>
                    <li>Correct any inaccurate or outdated personal information the organisation hold about them (or, if this is not possible, delete the inaccurate personal information)</li>
                    <li>Withdraw consent for any activities for which they have consented (e.g. direct marketing or cookies</li>
                  </ul>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Right to withdraw consent</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <p className="text-body text-mint-700 mb-4">
                    Customers cannot refuse collection, use and disclosure of their personal information if such information is required to: be collected, used or disclosed as required by any law; fulfil the terms of any contractual agreement; and be collected, used or disclosed as required by any regulators including self regulatory organisations
                  </p>
                  <p className="text-body text-mint-700 mb-4">
                    While you may request that we delete your contact details at any time, we cannot recall any email we have already sent. If you have any further enquiries about how to withdraw your consent, please feel free to enquire using the details provided in the Contact Us section of this privacy policy.
                  </p>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Right of access under PIPEDA</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <p className="text-body text-mint-700 mb-4">
                    If any organisational fees seem unjust, you have the right to complain about this. We retain the right to decide how we disclose the copies of your PII to you. We will take all necessary measures to fulfil your request in 30 days from receipt, otherwise we must inform you of our inability to do so before the 30-day timeframe if: meeting the time limit would unreasonably interfere with our business activities; or the time required to undertake consultations necessary to respond to the request would make it impractical to meet the time limit.
                  </p>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Right of rectification under PIPEDA</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Compliance with PIPEDA's ten principles of privacy</h3>
                  <p className="text-body text-mint-700 mb-4">
                    This privacy policy complies with the PIPEDA's requirements and ten principles of privacy, which are as follows:
                  </p>
                  <ul className="list-disc ml-6 space-y-2 text-body text-mint-700 mb-4">
                    <li><strong>Accountability.</strong> CSOgo is responsible for the PII under its control and will designate one or more persons to ensure organisational accountability for compliance with the ten principles of privacy under PIPEDA, whose details are included below. All personnel are accountable for the protection of customers' personal information.</li>
                    <li><strong>Identifying purposes.</strong> CSOgo identifies the purposes for which personal information is collected at or before the time the information is collected.</li>
                    <li><strong>Consent.</strong> Consent is required for CSOgo's collection, use or disclosure of personal information, except where required or permitted by PIPEDA or other law. In addition, when customers access a product or service offered by us, consent is deemed to be granted. Express consent may be obtained verbally, in writing or through electronic means. Alternatively, consent may be implied through the actions of customers or continued use of a product or service following CSOgo's notification of changes.</li>
                    <li><strong>Limiting collection.</strong> Personal information collected will be limited to that which is necessary for the purposes identified by CSOgo.</li>
                    <li><strong>Limiting use, disclosure and retention.</strong> We will not use or disclose personal information for purposes other than those for which the information was collected, except with your consent or as required by law. We will retain personal information only for as long as is necessary to fulfil the purposes for collecting such information and compliance with any legal requirements.</li>
                    <li><strong>Accuracy.</strong> Personal information will be maintained by CSOgo in an accurate, complete and up-to-date format as is necessary for the purpose(s) for which the personal information was collected.</li>
                    <li><strong>Safeguards.</strong> We will protect personal information with security safeguards appropriate to the sensitivity of such information.</li>
                    <li><strong>Openness.</strong> We will make our policies and practices relating to the collection and management of personal information readily available upon request, including our brochures or other information that explain our policies, standards, or codes.</li>
                    <li><strong>Customer access.</strong> We will inform customers of the existence, use and disclosure of their personal information and will provide access to their personal information, subject to any legal restrictions. We may require written requests for access to personal information and in most cases, will respond within 30 days of receipt of such requests. Customers may verify the accuracy and completeness of their personal information, and may request the personal information be corrected or updated, if appropriate.</li>
                    <li><strong>Challenging compliance.</strong> Customers are welcome to direct any questions or inquiries concerning our compliance with this privacy policy and PIPEDA requirements using the contact information provided in the Contact Us section of this privacy policy.</li>
                  </ul>

                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Anti-spam legislation</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Enquiries, reports and escalation</h3>
                  <p className="text-body text-mint-700 mb-4">
                    To enquire about CSOgo's privacy policy, or to report violations of user privacy, you may contact us using the details in the Contact us section of this privacy policy.
                  </p>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  <h2 className="text-heading font-semibold text-mint-900 mb-4">Additional disclosures for UK General Data Protection Regulation (UK GDPR) compliance (UK)</h2>
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Third-party provided content</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Additional disclosure for collection and use of personal information</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Personal information no longer required for our purposes</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Your data subject rights</h3>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <p className="text-body text-mint-700 mb-4">
                    <strong>When may the right to erasure apply?</strong>
                  </p>
                  <ul className="list-disc ml-6 space-y-2 text-body text-mint-700 mb-4">
                    ...
                    <li>If consent was the lawful basis for processing personal data and that consent has been withdrawn. CSOgo relies on consent to process personal data in very few circumstances.</li>
                  ...
                  <p className="text-body text-mint-700 mb-4">
                    However, the right to portability: only applies to personal data which a person has directly given to CSOgo in electronic form; and onward transfer will only be available where this is "technically feasible".
                  </p>
                  <p className="text-body text-mint-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-mint-900 mb-3 mt-6">Enquiries, reports and escalation</h3>
                  <p className="text-body text-mint-700 mb-4">
                    To enquire about CSOgo's privacy policy, or to report violations of user privacy, you may contact our Data Protection Officer using the details in the Contact us section of this privacy policy.
                  </p>
                  <p className="text-body text-mint-700 mb-4">
                ...
                <div>
                  ...
                  <p className="text-body text-mint-700 mb-4">
                    Cherisse Braithwaite-Joseph<br />
                    <a href="mailto:info@thecropperfoundation.org" className="text-mint-600 hover:text-mint-700 underline">
